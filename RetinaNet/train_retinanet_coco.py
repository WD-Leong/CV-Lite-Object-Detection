...
train_loss = \
    model_path + "coco_losses_retinanet_resnet50.csv"
ckpt_model = model_path + "coco_retinanet_resnet50"
restore_flag = True
...
retinanet_model = retinanet_module.RetinaNet(
    num_classes, label_2_id, 
    anchor_sizes=anchor_sizes, backbone_model="resnet50")
