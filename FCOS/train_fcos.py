...
# Training function. #
def train(
    train_data, training_loss, model, batch_size, 
    optimizer, ckpt, ck_manager, st_step, max_steps, 
    init_lr=1.0e-3, min_lr=1.0e-5, decay_step=1000, 
    decay_rate=0.99, display_step=50, step_save=100, 
...
train(
    voc_dataset, training_loss, fcos_model, 
