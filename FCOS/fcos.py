    ...
    for na in range(len(strides)):
        ...
        if len(tmp_idx) == 0:
            ...
            for n_label in range(len(tmp_sorted)):
                ...
                tmp_y_low = int((tmp_label[0]-tmp_label[2]/2) * h_ratio) + 1
                tmp_x_low = int((tmp_label[1]-tmp_label[3]/2) * w_ratio) + 1
                tmp_y_upp = int((tmp_label[0]+tmp_label[2]/2) * h_ratio) + 1
                tmp_x_upp = int((tmp_label[1]+tmp_label[3]/2) * w_ratio) + 1
