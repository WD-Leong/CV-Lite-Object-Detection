...
from fcos_center_v1 import prediction_to_corners
from fcos_center_v1 import build_model, format_data, model_loss
...
train_loss = voc_path + "voc_losses_fcos_center_resnet50.csv"
ckpt_model = voc_path + "voc_fcos_center_resnet50"
restore_flag = True
